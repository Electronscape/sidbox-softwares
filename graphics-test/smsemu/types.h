...
#define smsCYC_00		(duunmap_types[0] + 0)
#define smsCYC_ED		(duunmap_types[0] + 256 )			// 256b
#define smsCYC_DDFD		(duunmap_types[0] + 256 + 256) 		// 256b
#define smsCYC_CB		(duunmap_types[0] + 256 + 256 + 256) // 256b

#define smsVRAMLocation duunmap_textureid[0]        		// 16KB

#define smsCARTRam0 	(textures[0] + (16 * 1024))	// 16KB
#define smsCARTRam1 	(textures[0] + (32 * 1024))	// 16KB
#define smsSysRamBuff 	(textures[0] + (48 * 1024))	// 16KB
// fwd
//struct SMS_Ports;
