...
volatile uint8_t *ram[3];           // bus switch, not all values are listed here because the other

volatile uint8_t system_ram[8192];

volatile uint8_t vram[16384];
...
uint8_t MYRAM[512 * 1024];
uint8_t *smsRAMLocation = MYRAM;
