...
unsigned char DEFAULT_SYSFONT_TYPE1[256][8] = {
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },   // (  0)   0x00
    { 0x3C, 0x42, 0x95, 0xA1, 0xA1, 0x95, 0x42, 0x3C },   // (  1)   0x01
    { 0x10, 0x30, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x02 },   // (  2)   0x02
    { 0x30, 0x68, 0xF5, 0xFD, 0xFE, 0xFC, 0x78, 0x30 },   // (  3)   0x03
    ...
    { 0x00, 0x00, 0x00, 0x00, 0x60, 0x60, 0x00, 0x00 },   // ( 46)  [ . ]
    { 0x40, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x03, 0x01 },   // ( 47)  [ / ]
    { 0x00, 0x3E, 0x71, 0x59, 0x4D, 0x47, 0x3E, 0x00 },   // ( 48)  [ 0 ]
    { 0x00, 0x00, 0x02, 0x03, 0x7F, 0x00, 0x00, 0x00 },   // ( 49)  [ 1 ]
    { 0x00, 0x42, 0x63, 0x51, 0x49, 0x49, 0x46, 0x00 },   // ( 50)  [ 2 ]
    { 0x00, 0x22, 0x41, 0x49, 0x49, 0x49, 0x36, 0x00 },   // ( 51)  [ 3 ]
    { 0x18, 0x14, 0x12, 0x11, 0x11, 0x7F, 0x10, 0x00 },   // ( 52)  [ 4 ]
    { 0x00, 0x27, 0x45, 0x45, 0x45, 0x45, 0x39, 0x00 },   // ( 53)  [ 5 ]
    ...
    { 0x00, 0x00, 0x80, 0x66, 0x00, 0x00, 0x00, 0x00 },   // ( 59)  [ ; ]
    { 0x00, 0x08, 0x08, 0x14, 0x14, 0x22, 0x22, 0x00 },   // ( 60)  [ < ]
    { 0x00, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00 },   // ( 61)  [ = ]
    { 0x00, 0x22, 0x22, 0x14, 0x14, 0x08, 0x08, 0x00 },   // ( 62)  [ > ]
    { 0x00, 0x02, 0x03, 0x51, 0x59, 0x0F, 0x06, 0x00 },   // ( 63)  [ ? ]
    { 0x3E, 0x41, 0x41, 0x5D, 0x55, 0x15, 0x1E, 0x00 },   // ( 64)  [ @ ]
    { 0x00, 0x7E, 0x09, 0x09, 0x09, 0x09, 0x7E, 0x00 },   // ( 65)  [ A ]
    { 0x00, 0x7F, 0x49, 0x49, 0x49, 0x49, 0x36, 0x00 },   // ( 66)  [ B ]
    { 0x00, 0x1C, 0x22, 0x41, 0x41, 0x41, 0x41, 0x00 },   // ( 67)  [ C ]
    { 0x00, 0x7F, 0x41, 0x41, 0x41, 0x22, 0x1C, 0x00 },   // ( 68)  [ D ]
    { 0x00, 0x7F, 0x49, 0x49, 0x49, 0x41, 0x41, 0x00 },   // ( 69)  [ E ]
    { 0x00, 0x7F, 0x09, 0x09, 0x09, 0x01, 0x01, 0x00 },   // ( 70)  [ F ]
    { 0x00, 0x3E, 0x41, 0x41, 0x49, 0x49, 0x7A, 0x00 },   // ( 71)  [ G ]
    { 0x00, 0x7F, 0x08, 0x08, 0x08, 0x08, 0x7F, 0x00 },   // ( 72)  [ H ]
    { 0x00, 0x41, 0x41, 0x7F, 0x41, 0x41, 0x00, 0x00 },   // ( 73)  [ I ]
    { 0x00, 0x20, 0x40, 0x40, 0x40, 0x40, 0x3F, 0x00 },   // ( 74)  [ J ]
    { 0x00, 0x7F, 0x08, 0x08, 0x14, 0x22, 0x41, 0x00 },   // ( 75)  [ K ]
    { 0x00, 0x7F, 0x40, 0x40, 0x40, 0x40, 0x40, 0x00 },   // ( 76)  [ L ]
    { 0x7F, 0x01, 0x02, 0x04, 0x02, 0x01, 0x7F, 0x00 },   // ( 77)  [ M ]
    { 0x7F, 0x02, 0x04, 0x08, 0x10, 0x20, 0x7F, 0x00 },   // ( 78)  [ N ]
    { 0x00, 0x3E, 0x41, 0x41, 0x41, 0x41, 0x3E, 0x00 },   // ( 79)  [ O ]
    { 0x00, 0x7F, 0x09, 0x09, 0x09, 0x09, 0x06, 0x00 },   // ( 80)  [ P ]
    { 0x3E, 0x41, 0x41, 0x41, 0x61, 0x7E, 0x40, 0x00 },   // ( 81)  [ Q ]
    { 0x00, 0x7F, 0x09, 0x09, 0x09, 0x19, 0x66, 0x00 },   // ( 82)  [ R ]
    { 0x00, 0x26, 0x49, 0x49, 0x49, 0x49, 0x32, 0x00 },   // ( 83)  [ S ]
    { 0x00, 0x01, 0x01, 0x7F, 0x01, 0x01, 0x00, 0x00 },   // ( 84)  [ T ]
    { 0x00, 0x3F, 0x40, 0x40, 0x40, 0x40, 0x3F, 0x00 },   // ( 85)  [ U ]
    { 0x00, 0x0F, 0x30, 0x40, 0x40, 0x30, 0x0F, 0x00 },   // ( 86)  [ V ]
    { 0x7F, 0x60, 0x30, 0x18, 0x30, 0x60, 0x7F, 0x00 },   // ( 87)  [ W ]
    { 0x41, 0x22, 0x14, 0x08, 0x14, 0x22, 0x41, 0x00 },   // ( 88)  [ X ]
    { 0x01, 0x02, 0x04, 0x78, 0x04, 0x02, 0x01, 0x00 },   // ( 89)  [ Y ]
    { 0x00, 0x61, 0x51, 0x49, 0x45, 0x43, 0x00, 0x00 },   // ( 90)  [ Z ]
    { 0x00, 0x00, 0x7F, 0x41, 0x41, 0x41, 0x00, 0x00 },   // ( 91)  [ [ ]
    { 0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40 },   // ( 92)  [BACKSLASH]
    { 0x00, 0x00, 0x41, 0x41, 0x41, 0x7F, 0x00, 0x00 },   // ( 93)  [ ] ]
    { 0x08, 0x0C, 0x06, 0x03, 0x06, 0x0C, 0x08, 0x00 },   // ( 94)  [ ^ ]
    { 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80 },   // ( 95)  [ _ ]
    { 0x00, 0x00, 0x00, 0x03, 0x07, 0x04, 0x00, 0x00 },   // ( 96)  [ ` ]
    { 0x00, 0x20, 0x54, 0x54, 0x54, 0x54, 0x78, 0x00 },   // ( 97)  [ a ]
    { 0x00, 0x7F, 0x44, 0x44, 0x44, 0x44, 0x38, 0x00 },   // ( 98)  [ b ]
    { 0x00, 0x38, 0x44, 0x44, 0x44, 0x44, 0x28, 0x00 },   // ( 99)  [ c ]
    { 0x00, 0x38, 0x44, 0x44, 0x44, 0x44, 0x7F, 0x00 },   // (100)  [ d ]
    { 0x00, 0x38, 0x54, 0x54, 0x54, 0x54, 0x18, 0x00 },   // (101)  [ e ]
    { 0x00, 0x08, 0x7E, 0x09, 0x09, 0x01, 0x02, 0x00 },   // (102)  [ f ]
    { 0x00, 0x18, 0xA4, 0xA4, 0xA4, 0xA4, 0x7C, 0x00 },   // (103)  [ g ]
    { 0x00, 0x7F, 0x04, 0x04, 0x04, 0x04, 0x78, 0x00 },   // (104)  [ h ]
    { 0x00, 0x00, 0x44, 0x7D, 0x40, 0x00, 0x00, 0x00 },   // (105)  [ i ]
    { 0x00, 0x80, 0x80, 0x80, 0x7D, 0x00, 0x00, 0x00 },   // (106)  [ j ]
    { 0x00, 0x7F, 0x10, 0x10, 0x28, 0x44, 0x00, 0x00 },   // (107)  [ k ]
    { 0x00, 0x00, 0x00, 0x3F, 0x40, 0x40, 0x00, 0x00 },   // (108)  [ l ]
    { 0x00, 0x7C, 0x08, 0x18, 0x0C, 0x78, 0x00, 0x00 },   // (109)  [ m ]
    { 0x00, 0x7C, 0x04, 0x04, 0x04, 0x78, 0x00, 0x00 },   // (110)  [ n ]
    ...
    { 0x00, 0x7C, 0x04, 0x04, 0x04, 0x08, 0x00, 0x00 },   // (114)  [ r ]
    { 0x00, 0x08, 0x54, 0x54, 0x54, 0x54, 0x20, 0x00 },   // (115)  [ s ]
    { 0x00, 0x00, 0x04, 0x3F, 0x44, 0x40, 0x00, 0x00 },   // (116)  [ t ]
    { 0x00, 0x3C, 0x40, 0x40, 0x40, 0x7C, 0x00, 0x00 },   // (117)  [ u ]
    { 0x00, 0x1C, 0x20, 0x40, 0x20, 0x1C, 0x00, 0x00 },   // (118)  [ v ]
    { 0x00, 0x3C, 0x40, 0x30, 0x40, 0x3C, 0x00, 0x00 },   // (119)  [ w ]
    { 0x00, 0x44, 0x28, 0x10, 0x10, 0x28, 0x44, 0x00 },   // (120)  [ x ]
    { 0x00, 0x1C, 0xA0, 0x40, 0x20, 0x1C, 0x00, 0x00 },   // (121)  [ y ]
    { 0x00, 0x44, 0x64, 0x54, 0x4C, 0x44, 0x00, 0x00 },   // (122)  [ z ]
    { 0x00, 0x08, 0x08, 0x36, 0x41, 0x41, 0x41, 0x00 },   // (123)  [ { ]
    { 0x00, 0x00, 0x00, 0x7F, 0x00, 0x00, 0x00, 0x00 },   // (124)  [ | ]
    { 0x00, 0x41, 0x41, 0x41, 0x36, 0x08, 0x08, 0x00 },   // (125)  [ } ]
    { 0x02, 0x01, 0x01, 0x03, 0x02, 0x02, 0x01, 0x00 },   // (126)  [ ~ ]
    { 0x4C, 0x4C, 0x66, 0x66, 0x33, 0x33, 0x19, 0x19 },   // (127)   0x7F
    { 0x00, 0x1E, 0xA1, 0xE1, 0x21, 0x12, 0x00, 0x00 },   // (128)   0x80
    { 0x00, 0x3D, 0x40, 0x20, 0x7D, 0x00, 0x00, 0x00 },   // (129)   0x81
